...
export default function CheckoutWithSummary() {
                                    ...
                                    <div className="hidden lg:flex lg:flex-1 lg:items-center">
                                        <a href="#">
                                            ...
                                            <Image
                                                ...
                                                src="/mark.svg" width={100} height={100}
                                                alt=""
                                            />
                                        </a>
                                    </div>
                                        ...
                                        {products.map((product) => (
                                            <li key={product.id} className="flex px-4 py-6 sm:px-6">
                                                <div className="flex-shrink-0">
                                                    <Image width={900}
                                                        height={600} src={product.imageSrc} alt={product.imageAlt} className="w-20 rounded-md" />
                                                </div>
