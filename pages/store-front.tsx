                                                        ...
                                                        {category.featured.map((item) => (
                                                            <div key={item.name} className="group relative">
                                                                <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-100 group-hover:opacity-75">
                                                                    <Image fill src={item.imageSrc} alt={item.imageAlt} className="object-cover object-center" />
                                                                </div>
                                    ...
                                    <div>
                                        <div className="flex h-16 items-center justify-between">
                                            ...
                                            <div className="hidden lg:flex lg:flex-1 lg:items-center">
                                                <a href="#">
                                                    ...
                                                    <Image
                                                        ...
                                                        width={100} height={100} src="/mark.svg"
                                                        alt=""
                                            ...
                                            <a href="#" className="lg:hidden">
                                                <span className="sr-only">Your Company</span>
                                                <Image width={100} height={100} src="/mark.svg" alt="" className="h-8 w-auto" />
                                            </a>
                                        ...
                                        {categories.map((category) => (
                                            ...
                                            >
                                                <span aria-hidden="true" className="absolute inset-0">
                                                    <Image src={category.imageSrc} alt="" className="h-full w-full object-cover object-center" fill />
                                                </span>
                                                <span
                                                    aria-hidden="true"
